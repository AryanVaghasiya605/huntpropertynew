...
/* harmony export */   "PostedPropertyDetailsPageRoutingModule": () => (/* binding */ PostedPropertyDetailsPageRoutingModule)
/* harmony export */ });
...
const routes = [
    {
        path: '',
        component: _posted_property_details_page__WEBPACK_IMPORTED_MODULE_0__.PostedPropertyDetailsPage
    }
];
let PostedPropertyDetailsPageRoutingModule = class PostedPropertyDetailsPageRoutingModule {
};
PostedPropertyDetailsPageRoutingModule = (0,tslib__WEBPACK_IMPORTED_MODULE_1__.__decorate)([
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PostedPropertyDetailsPageModule": () => (/* binding */ PostedPropertyDetailsPageModule)
/* harmony export */ });
...
let PostedPropertyDetailsPageModule = class PostedPropertyDetailsPageModule {
};
PostedPropertyDetailsPageModule = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_4__.NgModule)({
        imports: [
            _angular_common__WEBPACK_IMPORTED_MODULE_5__.CommonModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__.FormsModule,
            _ionic_angular__WEBPACK_IMPORTED_MODULE_7__.IonicModule,
            _posted_property_details_routing_module__WEBPACK_IMPORTED_MODULE_0__.PostedPropertyDetailsPageRoutingModule,
            _angular_forms__WEBPACK_IMPORTED_MODULE_6__.ReactiveFormsModule,
        ],
        declarations: [_posted_property_details_page__WEBPACK_IMPORTED_MODULE_1__.PostedPropertyDetailsPage,
            src_app_add_button_add_button_page__WEBPACK_IMPORTED_MODULE_2__.AddButtonPage
        ]
    })
], PostedPropertyDetailsPageModule);
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "PostedPropertyDetailsPage": () => (/* binding */ PostedPropertyDetailsPage)
/* harmony export */ });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! tslib */ 42321);
/* harmony import */ var _posted_property_details_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./posted-property-details.page.html?ngResource */ 56897);
/* harmony import */ var _posted_property_details_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./posted-property-details.page.scss?ngResource */ 20687);
...
let PostedPropertyDetailsPage = class PostedPropertyDetailsPage {
    constructor(_fb, _camera, actionSheetCtrl, _activatedRoute, _maniSVC, _utilService, _router) {
        this._fb = _fb;
        this._camera = _camera;
        this.actionSheetCtrl = actionSheetCtrl;
        this._activatedRoute = _activatedRoute;
        this._maniSVC = _maniSVC;
        ...
        this.boudaryWallMade = [];
        this.occupancy = [];
        this.sharedOfficeSpace = [];
        this.personalWashroom = [];
        this.pantry = [];
        this.attachedBathroom = [];
        this.attachedBalcony = [];
        this.howoldisthePG = [];
        ...
        this.checkBoxData = [];
        this.selectedBedroomArray = [];
        this.formSubmittedStepOne = true;
        this.formSubmittedSteptwo = true;
        this.bedroomOptions = [1, 2, 3, 4, 5];
    ...
    getFinishingStatus(ev, AttributeName, AttributeId) {
        // console.log(ev.target.value);  
        this.attaributeData = {
    ...
    getInputField(ev, AttributeId, AttributeName, AttributeCode) {
        ...
        const existingIndex = this.attributesArray.findIndex((item) => item.AttributeId === AttributeId);
        const newValue = (_a = this.rentForm.get(AttributeCode)) === null || _a === void 0 ? void 0 : _a.value;
        if (existingIndex !== -1) {
        ...
        (_b = this.rentForm.get('Attributes')) === null || _b === void 0 ? void 0 : _b.setValue(this.attributesArray);
    }
    getAgeofConstruction(ev) {
        // console.log(ev.target.value);
    }
    getTypeOfOwnership(ev) {
        // console.log(ev.target.value);
    }
    getFacing(ev) {
        //console.log(ev.target.value);
    ...
    // }
    handleMinus(ev, AttributeId, AttributeName) {
    ...
    constructionAgeOnChange(event) {
        ...
        this.year = moment__WEBPACK_IMPORTED_MODULE_3__(event.target.value).format("YYYY");
        this.showYearDropDown = false;
    }
    onSubmit() {
...
PostedPropertyDetailsPage.ctorParameters = () => [
...
PostedPropertyDetailsPage = (0,tslib__WEBPACK_IMPORTED_MODULE_9__.__decorate)([
    (0,_angular_core__WEBPACK_IMPORTED_MODULE_10__.Component)({
        selector: 'app-posted-property-details',
        template: _posted_property_details_page_html_ngResource__WEBPACK_IMPORTED_MODULE_0__,
        styles: [_posted_property_details_page_scss_ngResource__WEBPACK_IMPORTED_MODULE_1__]
    })
], PostedPropertyDetailsPage);
...
/***/ 20687:
/*!*****************************************************************************************************!*\
  !*** ./src/app/select-package/posted-property-details/posted-property-details.page.scss?ngResource ***!
  \*****************************************************************************************************/
/***/ ((module) => {
...
/***/ 56897:
/*!*****************************************************************************************************!*\
  !*** ./src/app/select-package/posted-property-details/posted-property-details.page.html?ngResource ***!
  \*****************************************************************************************************/
/***/ ((module) => {

"use strict";
module.exports = "<ion-header>\r\n  <ion-toolbar>\r\n    <ion-title>Property Details</ion-title>\r\n  </ion-toolbar>\r\n</ion-header>\r\n\r\n<ion-content>\r\n  <ion-img src=\"../../../assets/images/bg_property_listing_top_720.png\"></ion-img>\r\n  \r\n  <form [formGroup]=\"rentForm\" (ngSubmit)=\"onSubmit()\">\r\n    <div class=\"form-steps\" *ngIf=\"steps === 1\">\r\n      <div class=\"formlist\">\r\n        <ul *ngFor=\"let list of allAttributes\">\r\n          <li>\r\n            <ion-item lines=\"none\" slot=\"start\">{{list.AttributeName}}              \r\n              <!-- <app-add-button *ngIf=\"list.AttributeName === 'Bedrooms' || list.AttributeName === 'Bathrooms' || list.AttributeName === 'Balconies'\" slot=\"end\" class=\"slide\" (handlePlusEv)=\"handlePlus($event)\"\r\n              (handleMinusEv)=\"handleMinus($event)\" [form]=\"rentForm\"\r\n              [control]=\"rentForm.get(list.AttributeName)\" [AttributeName]=\"list.AttributeName\" [AttributeId]=\"list.AttributeId\" [Value]=\"list.Id\"></app-add-button> -->\r\n             \r\n              <ion-select formControlName=\"{{list.AttributeCode}}\" *ngIf=\"list.AttributeName === 'Bedrooms'\" slot=\"end\" value=\"select\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of bedroomsOpt; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n              <ion-select formControlName=\"{{list.AttributeCode}}\" *ngIf=\"list.AttributeName === 'Bathrooms'\" slot=\"end\" value=\"\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of bathroomOpt; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>              \r\n              <ion-select formControlName=\"{{list.AttributeCode}}\" *ngIf=\"list.AttributeName === 'Balconies'\" slot=\"end\" value=\"\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of balconiesOpt; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n                <ion-select formControlName=\"{{list.AttributeCode}}\" slot=\"end\" *ngIf=\"list.AttributeCode === 'FinishingStatus'\" value=\"\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of finishingStatus; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'AgeOfConstruction'\" formControlName=\"{{list.AttributeCode}}\" value=\"{{ageOfCons[0]}}\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of ageOfCons; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'TypeOfOwnership'\" formControlName=\"{{list.AttributeCode}}\" value=\"{{typeOfOwnerShip[0]}}\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of typeOfOwnerShip; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'Facing'\" formControlName=\"{{list.AttributeCode}}\" value=\"{{facing[0]}}\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of facing; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'State'\" formControlName=\"{{list.AttributeCode}}\" [value]=\"stateListIndex\" placeholder=\"--Select--\" (ionChange)=\"stateLisOnChange($event)\">\r\n                <ion-select-option *ngFor=\"let item of stateList; let i = index\" value=\"{{item.Id}}\">{{item.State}}</ion-select-option>      \r\n              </ion-select>\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'City'\" formControlName=\"{{list.AttributeCode}}\" [value]=\"cityListIndex\" placeholder=\"--Select--\" (ionChange)=\"getSubcategory($event)\">\r\n                <ion-select-option *ngFor=\"let item of cityList; let i = index\" value=\"{{item.Id}}\">{{item.City}}</ion-select-option>      \r\n              </ion-select>\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'AvailableFrom'\" formControlName=\"{{list.AttributeCode}}\" value=\"{{availableFrom[0]}}\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of availableFrom; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'HowoldisthePG'\" formControlName=\"{{list.AttributeCode}}\" value=\"{{availableFrom[0]}}\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of howoldisthePG; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n\r\n              <ion-select slot=\"end\" *ngIf=\"list.AttributeCode === 'TenantsYouPrefer'\" formControlName=\"{{list.AttributeCode}}\" value=\"{{availableFrom[0]}}\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of tenantsYouPrefer; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n\r\n              <ion-input type=\"text\" slot=\"end\" *ngIf=\"list.AttributeType === 'text'\" (ionBlur)=\"getInputField($event, list.AttributeId, list.AttributeName, list.AttributeCode)\" formControlName=\"{{list.AttributeCode}}\"></ion-input>\r\n              <ion-input type=\"number\" slot=\"end\" *ngIf=\"list.AttributeType === 'number'\" (ionBlur)=\"getInputField($event, list.AttributeId, list.AttributeName, list.AttributeCode)\" formControlName=\"{{list.AttributeCode}}\"></ion-input>\r\n              \r\n              <ion-select formControlName=\"{{list.Occupancy}}\" *ngIf=\"list.AttributeName === 'Occupancy'\" slot=\"end\" value=\"select\" placeholder=\"--Select--\" (ionChange)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                <ion-select-option *ngFor=\"let item of occupancy; let i = index\" value=\"{{item}}\">{{item}}</ion-select-option>      \r\n              </ion-select>\r\n              <div class=\"furnishing-list\" slot=\"end\">\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'TransactionType'\">                \r\n                  <ul>\r\n                    <li *ngFor=\"let item of transactionType\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options1\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>\r\n                                                        \r\n                  </ul>\r\n                </div>\r\n                <div slot=\"end\" class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'PossessionStatus'\">                \r\n                  <ul>                    \r\n                    <li  *ngFor=\"let item of possessionStatus\">\r\n                      <label slot=\"end\" class=\"container\">\r\n                        <input type=\"radio\" name=\"options2\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'CarParking'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of carParking\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options3\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'Lift'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of lift\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options4\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'StoreRoom'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of storeRoom\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options5\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'ServantRoom'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of servantRoom\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options6\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'AnyConstructionDone'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of anyConstructionDone\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options7\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'BoudaryWallMade'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of boudaryWallMade\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options8\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\" >\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'SharedOfficeSpace'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of sharedOfficeSpace\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options9\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'PersonalWashroom'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of personalWashroom\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options10\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'Pantry'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of pantry\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options11\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'AttachedBathroom'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of attachedBathroom\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options12\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'AttachedBalcony'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of attachedBalcony\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options13\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>\r\n\r\n               \r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'CommonArea'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of commonArea\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options15\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div>  \r\n\r\n                <div class=\"furnishing-wrapper radio-list\" *ngIf=\"list.AttributeCode === 'FurnishingDetails'\">                \r\n                  <ul>                    \r\n                    <li *ngFor=\"let item of furnishingDetails\">\r\n                      <label class=\"container\">\r\n                        <input type=\"radio\" name=\"options16\" (change)=\"getFinishingStatus($event, list.AttributeName, list.AttributeId)\">\r\n                        {{item}}\r\n                        <span class=\"checkmark\"></span>\r\n                      </label>\r\n                    </li>                                                        \r\n                  </ul>\r\n                </div> \r\n               \r\n               \r\n              </div>\r\n              \r\n            </ion-item>\r\n          </li>\r\n        </ul>\r\n        \r\n      </div>\r\n     \r\n      <ion-item lines=\"none\">\r\n        <div *ngIf=\"!rentForm.invalid\">\r\n          <ion-text color=\"danger\">\r\n            <p>All fields are mandatory. Please provide all informations</p>\r\n          </ion-text>\r\n        </div>\r\n      </ion-item>\r\n    </div>\r\n    <div class=\"second-form-step\" *ngIf=\"steps === 2\">\r\n      <div class=\"checkboxList\">\r\n        Amenties:\r\n        <ul>\r\n          <li *ngFor=\" let list of allAmenties\">\r\n            <input id=\"{{list.Name}}\" type=\"checkbox\" (change)=\"isCheckBoxSelected($event, list.Id)\" class=\"styled-checkbox\" name=\"\"  value=\"{{list.Name}}\">\r\n            <label for=\"{{list.Name}}\">{{list.Name}}</label>\r\n          </li>\r\n        </ul>\r\n      </div>\r\n      <ion-item lines=\"none\">\r\n        <span class=\"monthlyRent\" slot=\"start\">\r\n          Property Name\r\n        </span>\r\n        <ion-item class=\"input\" lines=\"none\">\r\n          <ion-input formControlName=\"propertyName\"></ion-input>\r\n        </ion-item>\r\n      </ion-item>\r\n      <ion-item lines=\"none\">\r\n        <span class=\"monthlyRent\" slot=\"start\">\r\n          Property Title\r\n        </span>\r\n        <ion-item class=\"input\" lines=\"none\">\r\n          <ion-input formControlName=\"propertyTitle\"></ion-input>\r\n        </ion-item>\r\n      </ion-item>\r\n      <ion-item lines=\"none\">\r\n        <span class=\"monthlyRent\" slot=\"start\">\r\n          Description\r\n        </span>\r\n        <ion-item class=\"input\" lines=\"none\">\r\n          <ion-textarea formControlName=\"propertyDescription\"></ion-textarea>\r\n        </ion-item>\r\n      </ion-item>\r\n      \r\n      <ion-item lines=\"none\">\r\n        \r\n        <div *ngIf=\"!rentForm.invalid\">\r\n          <ion-text color=\"danger\">\r\n            <p>All fields are mandatory. Please provide all informations</p>\r\n          </ion-text>\r\n        </div>\r\n      </ion-item>\r\n    </div>\r\n      \r\n      <div class=\"step-four\" *ngIf=\"steps === 3\">\r\n        <div class=\"upload-icon\">\r\n          <img src=\"../../../assets/images/upload.png\" alt=\"\">\r\n          <input type=\"file\" accept=\".jpeg, .png\" (click)=\"uploadAction($event)\">\r\n        </div>\r\n      <div lines=\"none\" class=\"choose-file\" (click)=\"uploadAction($event)\">Choose File</div>\r\n      <div class=\"supported_format\">format accepted are .jpeg and .png</div>    \r\n      </div>\r\n      \r\n\r\n    <ion-item lines=\"none\">      \r\n      <ion-button *ngIf=\"hideNextBtn\" class=\"nextBtn\" type=\"submit\" >Next1</ion-button>      \r\n      <ion-button *ngIf=\"steps > 2 && showSubmitBtn\" class=\"nextBtn submitBtn\" type=\"submit\"  (click)=\"submitButtonClicked()\">Submit</ion-button>\r\n    </ion-item>\r\n  </form>\r\n</ion-content>";

/***/ })

}]);
//# sourceMappingURL=src_app_select-package_posted-property-details_posted-property-details_module_ts.js.map
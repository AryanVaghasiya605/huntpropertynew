...
const Menu = class {
  ...
  _setOpen(_x) {
    ...
    return (0,_Users_amitvasani_Desktop_mahesh_huntpropertynew_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* (shouldOpen, animated = true) {
...
const MenuButton = class {
  constructor(hostRef) {
    ...
    this.type = 'button';
    this.onClick = /*#__PURE__*/(0,_Users_amitvasani_Desktop_mahesh_huntpropertynew_node_modules_babel_runtime_helpers_esm_asyncToGenerator_js__WEBPACK_IMPORTED_MODULE_0__["default"])(function* () {
